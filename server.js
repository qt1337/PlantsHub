...
app.post("/api/request-reset-password",
         (req, res) => { user_api.requestResetPasswordKey(pool, req, res); });

app.post("/api/reset-password",
         (req, res) => { user_api.resetPasswordKey(pool, req, res); });

app.post("/api/update-user",
         (req, res) => { user_api.updateUser(pool, req, res); });

app.post("/api/delete-user",
         (req, res) => { user_api.deleteUser(pool, req, res); });
...
app.post("/api/get-diary-entries",
         (req, res) => { plant_api.getPlantDiaryEntries(pool, req, res); });

app.post("/api/create-diary-entry", upload.single("plantImage"),
         (req, res) => { plant_api.createPlantDiaryEntry(pool, req, res); });
