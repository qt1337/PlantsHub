...
const ActionStack = require('cordova-common/src/ActionStack');
const PlatformJson = require('cordova-common/src/PlatformJson');
const CordovaError = require('cordova-common/src/CordovaError');
const PlatformMunger = require('cordova-common/src/ConfigChanges/ConfigChanges').PlatformMunger;
const PluginInfoProvider = require('cordova-common/src/PluginInfo/PluginInfoProvider');
