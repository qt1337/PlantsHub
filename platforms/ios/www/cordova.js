...
define("cordova/exec", function(require, exports, module) {
  ...
  function convertMessageToArgsNativeToJs(message) {
    ...
    if (!message || !Object.prototype.hasOwnProperty.call(message, 'CDVType')) {
      ...
      message.messages.forEach(function(
          e) { args.push(massageMessageNativeToJs(e)); });
    } else {
  ...
  var iOSExec = function() {
    ...
    var command =
        [ callbackId, service, action, JSON.parse(JSON.stringify(actionArgs)) ];
  ...
  function execProxy() { cordovaExec().apply(null, arguments); }
...
define("cordova/plugin/ios/console", function(require, exports, module) {
  ...
  console.assert = function(expression) {
    ...
    var message =
        logger.format.apply(logger.format, [].slice.call(arguments, 1));
  ...
  // ------------------------------------------------------------------------------
  console.dir = function(object) { console.log('%o', object); };

  // ------------------------------------------------------------------------------
  console.dirxml = function(node) { console.log(node.innerHTML); };
  ...
  // ------------------------------------------------------------------------------
  console.time = function(name) { Timers[name] = new Date().valueOf(); };
  ...
  // ------------------------------------------------------------------------------
  console.table = function(data, columns) { console.log('%o', data); };
...
define("cordova/plugin/ios/launchscreen", function(require, exports, module) {
  ...
  var launchscreen = {
    show : function() { exec(null, null, 'LaunchScreen', 'show', []); },
    hide : function() { exec(null, null, 'LaunchScreen', 'hide', []); }
  };
...
define("cordova/plugin/ios/logger", function(require, exports, module) {
  ...
  // console log(message,...)             - logs a message at level LOG
...
define("cordova/plugin/ios/wkwebkit", function(require, exports, module) {
  ...
  var WkWebKit = {
    allowsBackForwardNavigationGestures : function(allow) {
      exec(null, null, 'CDVWebViewEngine',
           'allowsBackForwardNavigationGestures', [ allow ]);
    },
