...
const ConfigKeeper = require('cordova-common/src/ConfigChanges/ConfigKeeper');
const events = require('cordova-common/src/events');
const mungeutil = require('cordova-common/src/ConfigChanges/munge-util');
const xml_helpers = require('cordova-common/src/util/xml-helpers');
